...
exports.run = (client, message) => {
	let csgopng = "https://apprecs.org/gp/images/app-icons/300/60/net.bitsized.forgepaladins.jpg"
    var kasadancikanlar = [
	...
	.setAuthor('NBS Asistan Kasa Sistemi', csgopng)
	.setDescription(`${kasadancikanlar}`)
	.setFooter(`Kasayı açan (${message.author.username}) | Kasa Fiyatı: 80$ |`)
	.setColor("RANDOM")
