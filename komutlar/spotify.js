    ...
    if (user.presence.game.name === 'Spotify' && user.presence.game.type === 2) {
        try {
            ...
            const embed = new Discord.RichEmbed()
                ...
                .setFooter(`NBS Spotify Sistemi ${message.author.username} tarafından istendi.`, "https://cdn.discordapp.com/emojis/515260605347659777.png?v=1")
                .setDescription(`
\ Dinlediği şarkı:  \**${trackName}**\n
\ Dinlediği albüm:  \**${trackAlbum}**\n
\ Dinlediği sanatçı:  \**${trackAuthor}**\n
`)
        ...
        return message.channel.send(`**${user.tag}** kullanıcısı şuanda Discord'una **Spotify**'ı bağlamamış`);
    }
};
